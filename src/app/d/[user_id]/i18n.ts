...
const HI: Record<string, string> = {
  ...
  "All time": "अब तक",
  "all time": "अब तक",
  // student modal letter chart (ScoreChart)
  "Letter scores": "अक्षर स्कोर",
  "Letter Scores Over Time": "समय के साथ अक्षर स्कोर",
  "Letter learnt": "अक्षर सीखा",
  "No scores recorded": "कोई स्कोर दर्ज नहीं",
  "Loading scores...": "स्कोर लोड हो रहे हैं...",
  pts: "अंक",
  ...
  // metric toggle / tiles (METRICS in dashboard-types.ts)
  "Daily usage (5+ min)": "दैनिक उपयोग (5+ मिनट)",
  "NIPUN grade 2 proxy": "निपुण कक्षा 2 प्रॉक्सी",
  "NIPUN grade 3 proxy": "निपुण कक्षा 3 प्रॉक्सी",
  "MPL-B proxy": "एमपीएल-बी प्रॉक्सी",
  Usage: "उपयोग",
  "NIPUN g2 proxy": "निपुण क.2 प्रॉक्सी",
  "NIPUN g3 proxy": "निपुण क.3 प्रॉक्सी",
  min: "मिनट",
  "Minutes per student": "प्रति छात्र मिनट",
  "min yesterday": "मिनट (कल)",
  "5+ min yesterday": "कल 5+ मिनट",
  yesterday: "कल",
  "hover a bar for details": "विवरण के लिए बार पर होवर करें",
  "click a bar to select": "चुनने के लिए बार पर क्लिक करें",
  Rank: "रैंक",
